...
import { Globe, Tv, Printer, LogOut, CheckCircle, AlertCircle, RefreshCw, Trash2, User, Network, Usb, Check, AlertTriangle, Cpu, Play, MessageSquare, Plus, Edit, X, Upload, Truck, Tag } from "lucide-react";
import { DeliveryConfigPanel } from "@/components/features/settings/delivery-config-panel";
import { proxyRequest } from "@/lib/proxy-client";
import { motion, AnimatePresence } from "framer-motion";
import { useLocalBridge, BridgeConfig } from "@/hooks/use-local-bridge";
import { renderReceiptToImage } from "@/lib/utils/print-utils";
import { TagsPanel } from "@/components/features/settings/tags-panel";
import { InstagramConnectPanel, InstagramIcon } from "@/components/features/settings/instagram-connect-panel";
import { MessageTemplatePanel } from "@/components/features/settings/message-template-panel";
...
export function SettingsScreen() {
  ...
  const [activeTab, setActiveTab] = useState<"general" | "account" | "instagram" | "printer" | "messageTemplate" | "delivery" | "tags">("general");
  ...
  const tabs = [
    ...
    { id: "delivery", label: "Vận chuyển", desc: "API đối tác vận chuyển", icon: Truck },
    { id: "messageTemplate", label: "Mẫu tin nhắn", desc: "Kịch bản tin nhắn tự động", icon: MessageSquare },
    { id: "tags", label: "Thẻ nhãn (Tags)", desc: "Quản lý nhãn phân loại khách", icon: Tag },
  ];
