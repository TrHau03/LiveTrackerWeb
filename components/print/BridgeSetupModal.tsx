        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-between items-center border-t border-[var(--border)] pt-4 mt-2">
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto justify-center sm:justify-start">
              <a
                href="https://github.com/duyzxje/LiveTrackerLocalBridge/releases/latest/download/livetracker-windows-amd64.exe"
                target="_blank"
              ...
              <a
                href="https://github.com/duyzxje/LiveTrackerLocalBridge/releases/latest/download/livetracker-macos-arm64.zip"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                Tải cho Mac (M1/M2/M3)
              </a>
              <a
                href="https://github.com/duyzxje/LiveTrackerLocalBridge/releases/latest/download/livetracker-macos-amd64.zip"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-9 items-center justify-center gap-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-white px-3 text-xs font-medium shadow-sm transition border border-zinc-700"
              >
